...
# def insert_video_playlist(youtube, playlist_id, video_id):
def insert_video_playlist(youtube, options):
    print(f'playlist: {options.playlist_id}\nvideo: {options.video_id}')
    insert_video_request = youtube.playlistItems().insert(
        part='snippet',
        body=dict(
            snippet=dict(
...
if __name__ == '__main__':
    ...
    argparser.add_argument("--playlist-id",  required=True,
                           help="Playlist ID to feature on your channel")
    ...
    try:
        ...
        insert_video_playlist(youtube, args)

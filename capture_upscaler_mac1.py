...
UPSCALED_PATH2_FFMPEG_COMMAND = f'/opt/homebrew/bin/ffmpeg -y -i {UPSCALED_TEMP_INTERM_FILE_NAME} -c:v hevc_videotoolbox -b:v 60M -pix_fmt yuv420p -c:a aac -b:a 192k {UPSCALED_TEMP_FILE_NAME}'

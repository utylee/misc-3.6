...
class Studio:
    ...
    # 버전이 낮다고 쿠키가 안먹히는 문제가 있었습니다. youtube 경고페이지를 띄웠습니다.
    # 정책을 업데이트한 것 같습니다. 버전을 하나씩 올려보니 성공했습니다
    ...
    USER_AGENT = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/637.36 (KHTML, like Gecko) Chrome/90.0.3987.163 Safari/637.36"
